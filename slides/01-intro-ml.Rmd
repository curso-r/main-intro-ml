...
arvore <- rpart::rpart(vendas ~ investimento + midia, data = adv_ok, control = rpart.control(minbucket = 100))
...
```{r}
arvore <- rpart::rpart(vendas ~ investimento + midia, data = adv_ok, control = rpart.control(minbucket = 5))
arvore %>% rpart.plot::rpart.plot(type = 2, extra = 1)
```
